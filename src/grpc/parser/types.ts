...
/** A Buffer descriptor as emitted by protobufjs / Yellowstone. @since 1.0.0 */
export interface RawBuffer {
  type: 'Buffer';
  data: number[];
}

/** Raw protobuf Timestamp (seconds as string, nanos). @since 1.0.0 */
export interface RawTimestamp {
  seconds: string;
  nanos: number;
}

/** Raw transaction signature + message + meta as received from gRPC. @since 1.0.0 */
...
/** Raw token balance from gRPC meta. @since 1.0.0 */
...
/** Raw inner instruction set. @since 1.0.0 */
export interface RawInnerInstruction {
  index: number;
  instructions: RawCompiledInstruction[];
}

/** Raw compiled instruction from protobuf. @since 1.0.0 */
...
/** Raw account update from geyser subscribe. @since 1.0.0 */
...
/** Raw block meta update. @since 1.0.0 */
...
/** Raw entry notification. @since 1.0.0 */
...
/** Parsed balance change for a single account. @since 1.0.0 */
...
/** Parsed token balance change. @since 1.0.0 */
...
/** A single decoded instruction. @since 1.0.0 */
...
/** Parsed transaction from a gRPC subscription. @since 1.0.0 */
...
/** Parsed account update from a gRPC subscription. @since 1.0.0 */
...
/** Parsed slot update. @since 1.0.0 */
...
/** Parsed entry notification. @since 1.0.0 */
...
/** Options for the GeyserParser. @since 1.0.0 */

/**
 * @module ai/gateway/x402/types
 * @description x402 Protocol Types — Canonical types following the Coinbase x402 v1 & v2 specification.
 *
...
/**
 * @description CAIP-2 style network identifier — "namespace:reference".
 * @since 1.0.0
 */
...
/**
 * @description Determine whether a CAIP-2 network is SVM-based (Solana).
 * @param {X402Network} network - The CAIP-2 network identifier
 * @returns {boolean} True if the network is Solana-based
 * @since 1.0.0
 */
...
/**
 * @description Determine whether a CAIP-2 network is EVM-based.
 * @param {X402Network} network - The CAIP-2 network identifier
 * @returns {boolean} True if the network is EVM-based
 * @since 1.0.0
 */
...
/**
 * @description Describes the resource being accessed (included in 402 responses).
 * @since 1.0.0
 */
...
/**
 * @description A single acceptable payment method.
...
/**
 * @description The full 402 Payment Required response body (v2).
...
/**
 * @description The payment payload sent by the client.
...
/**
 * @description Solana (SVM) specific payload for the "exact" scheme.
 * @since 1.0.0
 */
...
/**
 * @description EVM (EIP-3009) specific payload for the "exact" scheme — used for USDC.
 * @since 1.0.0
 */
...
/**
 * @description EVM (Permit2) specific payload for the "exact" scheme — universal ERC-20.
 * @since 1.0.0
 */
...
/**
 * @description Response from the facilitator's /verify endpoint.
 * @since 1.0.0
 */
...
/**
 * @description Response from the facilitator's /settle endpoint.
 * @since 1.0.0
 */
...
/**
 * @description Settlement response sent in the PAYMENT-RESPONSE header.
 * @since 1.0.0
 */
...
/**
 * @description Auth headers factory for facilitator endpoints.
...
/**
 * @description Facilitator configuration — fully controlled by the developer.
 *
...
/**
 * @description Supported payment kind (returned by facilitator /supported endpoint).
 * @since 1.0.0
 */
export interface X402SupportedKind {
  ...
  network: X402Network;
  /** Extra data (e.g. { feePayer: "..." } for Solana, { name, version } for EVM) */
  extra?: Record<string, unknown>;
}

/**
 * @description Response from the facilitator's /supported endpoint (v2).
 * @since 1.0.0
 */
export interface X402SupportedResponse {
  ...
  extensions: string[];
  /** Signer addresses by CAIP family pattern (e.g. "solana:*" → addresses) */
...
/**
 * @description Per-method (route) payment configuration.
 * @since 1.0.0
 */
...
/**
 * @description Full x402 integration configuration for the gateway.

...
const zSolBalanceChange = z.object({
  account: z.string(),
  lamports: z.number().int(),
});
const zTokenBalanceChange = z.object({
  owner: z.string(),
  mint: z.string(),
  rawAmount: z.string(),
});
...
registerUtilia(
  ...
  z.object({
    ...
    solBalanceChanges: z.array(zSolBalanceChange),
    tokenBalanceChanges: z.array(zTokenBalanceChange),

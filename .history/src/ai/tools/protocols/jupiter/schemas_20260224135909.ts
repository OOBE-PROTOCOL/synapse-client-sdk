/**
 * Jupiter Protocol — Zod schemas for all 22 Jupiter API methods.
 *
 * Covers:
 ...
 *
 * @module protocols/jupiter/schemas
 */
import { z } from 'zod';
...
register(
  ...
  z.object({
    ...
    dynamicSlippage: z.boolean().optional(),
    quoteResponse: z.record(z.unknown()).describe('The full quoteResponse object from getQuote'),
  }),
  z.object({
...
/** All 22 registered Jupiter methods with typed Zod schemas. */
export const jupiterMethods = methods;

/** Jupiter method names as a readonly tuple for allow-listing. */

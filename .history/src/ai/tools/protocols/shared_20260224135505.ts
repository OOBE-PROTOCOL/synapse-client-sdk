/**
 * Shared infrastructure for protocol-specific AI tools.
 *
 * Provides:
...
/** A registered protocol method with Zod schemas for agent discovery. */
...
/**
 * Creates an isolated method registry scoped to a single protocol.
 *
...
/** Configuration for a protocol HTTP client instance. */
...
/** Typed error for protocol REST API failures. */
...
/** A single LangChain-compatible tool. */
export type ProtocolTool = ReturnType<typeof tool>;

/** Toolkit shape returned by every createXxxTools() factory. */
...
/** Common options accepted by every createXxxTools() factory. */

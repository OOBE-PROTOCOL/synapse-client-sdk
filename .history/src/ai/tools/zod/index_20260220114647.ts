...
/* Side-effect: executes all registerRpcMethod() calls.
 * Uses require() to avoid ESM import hoisting which would cause a TDZ error
 * (the static import would be evaluated before `agentRpcMethods` is initialised). */
require('./types');
      ...
      const t = lcTool(
        async (input: Record<string, unknown>) => {
          try {
            ...
            const result = await this.execute(sessionId, method.name, params);
        ...
        },
        {
          ...
          description: `[Metered] ${method.description}. Session: ${sessionId.slice(0, 8)}…`,
          schema: method.input as import('zod').ZodObject<Record<string, import('zod').ZodType>>,
        },
      );
      tools.push(t);
    }

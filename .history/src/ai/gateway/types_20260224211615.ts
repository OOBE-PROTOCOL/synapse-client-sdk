/**
 * @module ai/gateway/types
 * @description Synapse Agent Gateway — Core type definitions.
 *
...
/**
 * @description Unique identifier for an agent within the Synapse network.
 * @since 1.0.0
 */
export type AgentId = string & { readonly __brand: 'AgentId' };

/**
 * @description Create a branded AgentId from a plain string.
 * @param {string} v - The string value to brand as an AgentId
 * @returns {AgentId} A branded AgentId
 * @since 1.0.0
 */
export const AgentId = (v: string): AgentId => v as AgentId;

/**
 * @description DID-style agent identity with optional verification.
 * @since 1.0.0
 */
...
/**
 * @description Signed credential proving an agent's identity ownership.
 * @since 1.0.0
 */
...
/**
 * @description Supported payment tokens for x402 settlements.
 * @since 1.0.0
 */
...
/**
 * @description A single pricing tier for a tool or bundle.
 * @since 1.0.0
 */
...
/**
 * @description x402 payment intent — what the buyer sends before a session starts.
 * @since 1.0.0
 */
...
/**
 * @description Receipt of a settled payment (on-chain or off-chain).
 * @since 1.0.0
 */
...
/**
 * @description Possible lifecycle states for an agent session.
 * @since 1.0.0
 */
export type SessionStatus = 'pending' | 'active' | 'paused' | 'exhausted' | 'settled' | 'expired';

/**
 * @description A metered agent session — tracks usage, budget, rate limits.
 * @since 1.0.0
 */
...
/**
 * @description Cryptographic attestation of an RPC response (Proof of Computation).
 * @since 1.0.0
 */
...
/**
 * @description Result wrapper that includes optional attestation and latency info.
...
/**
 * @description A tool listing in the agent marketplace.
 * @since 1.0.0
 */
...
/**
 * @description A bundle of tools sold together (e.g. "DeFi Pack", "NFT Read-Only").
 * @since 1.0.0
 */
...
/**
 * @description Handler function for gateway events.
 * @template T The type of the event data payload
 * @since 1.0.0
 */

...
const REGISTRY: ReadonlyMap<EndpointKey, SynapseEndpoint> = Object.freeze(
  new Map<EndpointKey, SynapseEndpoint>([
    ...
    [key(SynapseNetwork.Devnet, SynapseRegion.EU), ep(SynapseNetwork.Devnet, SynapseRegion.EU, 'staging.oobeprotocol.ai')],

    // ── Testnet ────────────────────────────────────────────
    [key(SynapseNetwork.Testnet, SynapseRegion.US), ep(SynapseNetwork.Testnet, SynapseRegion.US, 'us-1-testnet.oobeprotocol.ai')],
    [key(SynapseNetwork.Testnet, SynapseRegion.EU), ep(SynapseNetwork.Testnet, SynapseRegion.EU, 'staging.oobeprotocol.ai')],
  ]),
);

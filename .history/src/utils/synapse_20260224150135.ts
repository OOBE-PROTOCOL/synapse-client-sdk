...
interface ServiceEndpoint {
    url: string | string[] | null; // Allow for multiple URLs for load balancing or failover;
}
/**
 ...
 */
export type SynapseEndpointsService = <T,U>() => SynapseEndpoints<T,U>;
 ...
 */
export interface SynapseEndpoints<T,U> {
    region: T;
    rpc: U;
    wss?: U;
    grpc?: U;
...
export const SYNAPSE_ENDPOINTS: Record<CountryEndpoint, SynapseEndpoints<CountryEndpoint, ServiceEndpoint>> = {
    [CountryEndpoint.US]: {
        ...
        wss: {
                url: 'wss://us-1-mainnet.oobeprotocol.ai/ws',
        },
        grpc: {
                url: 'https://us-1-mainnet.oobeprotocol.ai/grpc',
        }
    },
    [CountryEndpoint.EU]: {
        ...
        wss: {
                url: 'wss://staging.oobeprotocol.ai/ws',
        },
        grpc: {
                url: 'https://staging.oobeprotocol.ai/grpc',
        }
    },
}
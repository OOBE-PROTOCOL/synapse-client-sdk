...
export class SolanaRpc {
  ...
  getBalance(pubkey: Pubkey, commitment?: Commitment, opts?: CallOptions) { return m.getBalance(this.t, pubkey, commitment, opts); }
  ...
  getBlockHeight(commitment?: Commitment, opts?: CallOptions) { return m.getBlockHeight(this.t, commitment, opts); }
  ...
  // ── Blockhash ──────────────────────────────────────────────────
  getLatestBlockhash(commitment?: Commitment, opts?: CallOptions) { return m.getLatestBlockhash(this.t, commitment, opts); }
  isBlockhashValid(blockhash: string, commitment?: Commitment, opts?: CallOptions) { return m.isBlockhashValid(this.t, blockhash, commitment, opts); }

  // ── Cluster / Epoch ────────────────────────────────────────────
  getSlot(commitment?: Commitment, opts?: CallOptions) { return m.getSlot(this.t, commitment, opts); }
  getSlotLeader(commitment?: Commitment, opts?: CallOptions) { return m.getSlotLeader(this.t, commitment, opts); }
  getSlotLeaders(startSlot: Slot, limit: number, opts?: CallOptions) { return m.getSlotLeaders(this.t, startSlot, limit, opts); }
  getEpochInfo(commitment?: Commitment, opts?: CallOptions) { return m.getEpochInfo(this.t, commitment, opts); }
  ...
  getVoteAccounts(commitment?: Commitment, opts?: CallOptions) { return m.getVoteAccounts(this.t, commitment, opts); }
  getClusterNodes(opts?: CallOptions) { return m.getClusterNodes(this.t, opts); }
  getSupply(commitment?: Commitment, opts?: CallOptions) { return m.getSupply(this.t, commitment, opts); }
  ...
  getTransactionCount(commitment?: Commitment, opts?: CallOptions) { return m.getTransactionCount(this.t, commitment, opts); }
  ...
  getTokenAccountsByOwner(owner: Pubkey, filter: { mint: Pubkey } | { programId: Pubkey }, commitment?: Commitment, opts?: CallOptions) { return m.getTokenAccountsByOwner(this.t, owner, filter, commitment, opts); }
  getTokenAccountsByDelegate(delegate: Pubkey, filter: { mint: Pubkey } | { programId: Pubkey }, commitment?: Commitment, opts?: CallOptions) { return m.getTokenAccountsByDelegate(this.t, delegate, filter, commitment, opts); }
  ...
  getFeeForMessage(message: string, commitment?: Commitment, opts?: CallOptions) { return m.getFeeForMessage(this.t, message, commitment, opts); }
}

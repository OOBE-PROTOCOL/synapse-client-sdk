/**
 * getSignaturesForAddress — paginated transaction history.
 */
...
/**
 * Auto-paginating signature fetch with safety guards.
 * Set `limit` to control total results (default 100, max ~50k).
 */
